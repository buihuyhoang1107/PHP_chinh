...
//Truy Vấn câu lệnh
$query_two_posts = "SELECT p.*,c.title AS 'category' FROM `posts` p LEFT JOIN categories c ON p.category_id = c.id WHERE p.`status` = 1 ORDER BY created_at  desc limit 7,2";
					...
					<div class="col-md-6">
						<div class="post post-thumb">
							...
							<div class="post-body">
								...
								<h3 class="post-title"><a href="blog-post.php?id=<?php echo $posts_two_post['id']; ?>"><?php echo $posts_two_post['title']; ?></a></h3>
							</div>
						</div>
					</div>
					<!-- /post -->
							...
							<div class="col-md-12">
								<div class="post post-thumb">
									...
									<div class="post-body">
										...
										<h3 class="post-title"><a href="blog-post.php?id=<?php echo $post_x['id']; ?>"><?php echo $post_x['title']; ?></a></h3>
									</div>
								</div>
							</div>
					<!-- <!can chu y-- ----------------------------------------------- --> 
