					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="post post-thumb">
								<a class="post-img" href="blog-post.html"><img src="./img/<?php echo $post_in_3post['thumbnail']; ?>" alt=""></a>
								<div class="post-body">
									<div class="post-meta">
									...
									<h3 class="post-title"><a href="blog-post.html"><?php echo $post_in_3post['title']; ?></a></h3>
								</div>
							</div>
						</div>
						<!-- /post -->
							...
							<div class="col-md-6">
								<div class="post">
									...
									<div class="post-body">
										...
										<h3 class="post-title"><a href="blog-post.html"><?php echo $post_post['title']; ?></a></h3>
									</div>
								</div>
							</div>
							<!-- /post -->
						...
						<div class="col-md-12">
							<div class="post post-row">
								<a class="post-img" href="blog-post.html"><img src="./img/<?php echo $post_p5['thumbnail']; ?>" alt=""></a>
								<div class="post-body">
									<div class="post-meta">
										<a class="post-category cat-2" href="#"><?php echo $post_p5['category']; ?></a>
										<span class="post-date"><?php echo $post_p5['created_at']; ?></span>
									</div>
									<h3 class="post-title"><a href="blog-post.html"><?php echo $post_p5['title']; ?></a></h3>
